...
<head>
    ...
    <link rel="icon" href="${yeqifu}/static/favicon.icon">
    <link rel="stylesheet" href="${yeqifu}/static/layui/css/layui.css" media="all" />
    <link rel="stylesheet" href="${yeqifu}/static/css/public.css" media="all" />
</head>
<body class="loginBody">
<form class="layui-form" id="loginFrm" method="post" action="${yeqifu}/login/login.action">
    <div class="login_face"><img src="${yeqifu}/static/images/title.jpg" class="userAvatar"></div>
    ...
    <p style="width: 85%"><a href="${yeqifu}/login/toRegist.action"  class="fl">还没有账号？立即注册</a></p>
