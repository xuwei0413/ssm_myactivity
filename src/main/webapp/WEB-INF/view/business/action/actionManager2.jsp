...
<div id="customerBar" style="display: none;">
    <a class="layui-btn layui-btn-xs layui-btn-radius" lay-event="join">加入</a>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer','laydate', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${yeqifu}/action2/loadAll.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${yeqifu}/action2/loadAll.action?" + params,
                page: {curr: 1}
            })
        });
        ...
        //加入活动
        function openJoinCustomer(data) {
            if(data.status=='组团成功'){
                layer.confirm('【' + data.custname + '】这个活动人数已满？')
                return;
            }
            mainIndex = layer.open({
                type: 1,
                ...
                success: function (index) {
                    form.val("dataFrm", data);
                    url = "${yeqifu}/action2/join.action";
                }
            });
        }
