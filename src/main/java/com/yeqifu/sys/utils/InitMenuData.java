...
public class InitMenuData {
    public static void main(String[] args) {
        ...
        menuMapper.insert(new Menu(1,0,"随团旅行管理系统",null,1,null,"&#xe68e;",1));
        ...
        //业务管理子节点
        menuMapper.insert(new Menu(8,3,"汽车借用",null,0,null,"&#xe65b;",1));
        menuMapper.insert(new Menu(9,3,"借用单管理",null,0,null,"&#xe6b2;",1));
