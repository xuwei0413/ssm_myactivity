define("gallery2/swfupload/2.2.0/swfupload", [], function (require, exports, module) {
    var SWFUpload;
    return void 0 == SWFUpload && (SWFUpload = function (a) {
        ...
        try {
            ...
            this.settings = a,
            this.eventQueue = [], 
            this.movieName = "SWFUpload_" + mydate.getTime().toString()+"_"+ SWFUpload.movieCount++,
        ...
        try {
            if (this.movieElement && "unknown" == typeof a.CallFunction) {
                ...
                for (var b in a) try {
                    "function" == typeof a[b] && b[0] <= "Z" && (a[b] = null)
                } catch (c) {}
            }
        } catch (d) {}
    ...
    }, window.SWFUpload = SWFUpload, SWFUpload
});